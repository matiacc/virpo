    ...
    <table class="style1">
        ...
        <tr>
            <td style="height: 20px; text-align: left;" colspan="3">
                <asp:Label ID="lblMsj" runat="server" 
                    Text="Deje sus datos y nos comunicaremos con usted a la brevedad" 
        ...
        <tr>
            <td style="text-align: left">
                <asp:Label ID="lblEmpresa" runat="server" Text="Empresa a Publicitar:" 
        ...
        <tr>
            <td style="text-align: left">
                <asp:Label ID="lblContacto" runat="server" Text="Nombre del Contacto:" 
                    CssClass="estiloLabel"></asp:Label>
            </td>
            <td>
        ...
        <tr>
            <td style="text-align: left">
                <asp:Label ID="lblTel" runat="server" Text="Telefono de Contacto:" 
                    CssClass="estiloLabel"></asp:Label>
            </td>
            <td>
        ...
        <tr>
            <td style="text-align: left">
                <asp:Label ID="lblMail" runat="server" Text="Mail de Contacto:" 
                    CssClass="estiloLabel"></asp:Label>
            </td>
            <td>
        ...
        <tr>
            <td style="text-align: left">
                <asp:Label ID="lblMeses" runat="server" Text="Meses de Publicidad:" 
                    CssClass="estiloLabel"></asp:Label>
            </td>
            <td>
        ...
        <tr>
            <td style="text-align: left">
                <asp:Label ID="lblFrec" runat="server" Text="Impresiones Diarias :" 
                    CssClass="estiloLabel"></asp:Label>
            </td>
            <td>
        ...
        <tr>
            <td style="text-align: left">
                <asp:Label ID="lblConsulta" runat="server" Text="Dejanos tu Consulta:" 
                    CssClass="estiloLabel"></asp:Label>
            </td>
            <td>
