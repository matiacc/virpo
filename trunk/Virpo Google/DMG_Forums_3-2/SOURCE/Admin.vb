...
Namespace DMGForums.Admin
	...
	Public Class AdminPage
		...
		Sub OpenConfig(sender As System.Object, e As System.EventArgs)
			...
			elseif sender.CommandArgument = 16 then
				...
				if (HtmlFormList.Items.Count = 0) then
					PagePanel.visible = "false"
                    NoItemsDiv.InnerHtml = "No HTML Forms Have Been Submitted<br /><br /><a href=""javascript:openHelp('DMGHtmlForms.html')"">Click Aquí</a> to learn how to use this feature.<br /><br />"
                End If
        ...
        Sub SubmitMainConfig(ByVal sender As System.Object, ByVal e As System.EventArgs)
            ...
            PagePanel.Visible = "false"
            NoItemsDiv.InnerHtml = "Main Configuration Edited.<br /><a href=""admin.aspx"">Click Aquí</a> To Return To The Admin Page.<br /><br />"
        End Sub

        Sub SubmitForumConfig(ByVal sender As System.Object, ByVal e As System.EventArgs)
            ...
            PagePanel.Visible = "false"
            NoItemsDiv.InnerHtml = "Forum Options Edited.<br /><a href=""admin.aspx"">Click Aquí</a> To Return To The Admin Page.<br /><br />"
        End Sub

        Sub CreateNewTemplate(ByVal sender As System.Object, ByVal e As System.EventArgs)
            AdminLinks.visible = "false"
        ...
        Sub DeleteTemplateMenu(ByVal sender As System.Object, ByVal e As System.EventArgs)
            AdminLinks.visible = "false"
            ...
            If (TemplatesList.Items.Count = 0) Then
                PagePanel.visible = "false"
                NoItemsDiv.InnerHtml = "There are no unused or non-default templates.<br /><a href=""admin.aspx"">Click Aquí</a> To Return To The Admin Page.<br /><br />"
            End If
            TemplatesList.Datasource.Close()
        End Sub

        Sub DeleteTemplate(ByVal sender As System.Object, ByVal e As System.EventArgs)
            Database.Write("DELETE FROM " & Database.DBPrefix & "_SETTINGS WHERE ID = " & sender.CommandArgument)
            PagePanel.visible = "false"
            NoItemsDiv.InnerHtml = "Template Deleted Successfully.<br /><a href=""admin.aspx"">Click Aquí</a> To Return To The Admin Page.<br /><br />"
        End Sub

        Sub SelectTemplate(ByVal Type As Integer)
            AdminLinks.visible = "false"
        ...
        Sub EditMainMenu(ByVal sender As System.Object, ByVal e As System.EventArgs)
            AdminLinks.visible = "false"
        ...
        Sub MainMenuOrderUp(ByVal sender As System.Object, ByVal e As System.EventArgs)
            AdminLinks.visible = "false"
            AdminMainMenuConfig.visible = "true"
        ...
        Sub MainMenuOrderDown(ByVal sender As System.Object, ByVal e As System.EventArgs)
            AdminLinks.visible = "false"
            AdminMainMenuConfig.visible = "true"
            Dim CurrentLink As Integer = sender.CommandArgument
        ...
        Sub MainMenuNewLink(ByVal sender As System.Object, ByVal e As System.EventArgs)
            AdminLinks.visible = "false"
            AdminMainMenuConfig.visible = "true"
        ...
        Sub MainMenuSaveLink(ByVal sender As System.Object, ByVal e As System.EventArgs)
            AdminLinks.visible = "false"
            AdminMainMenuConfig.visible = "true"
        ...
        Sub MainMenuDeleteLink(ByVal sender As System.Object, ByVal e As System.EventArgs)
            AdminLinks.visible = "false"
            AdminMainMenuConfig.visible = "true"
        ...
        Sub ChangeCustomHTML(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Sub ChangeColors(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Sub SubmitColorConfig(ByVal sender As System.Object, ByVal e As System.EventArgs)
            ...
            PagePanel.Visible = "false"
            NoItemsDiv.InnerHtml = "Colors & Fonts Configuration Edited.<br /><a href=""admin.aspx"">Click Aquí</a> To Return To The Admin Page.<br /><br />"
        End Sub

        Sub SubmitCustomHTML(ByVal sender As System.Object, ByVal e As System.EventArgs)
            ...
            PagePanel.Visible = "false"
            NoItemsDiv.InnerHtml = "Custom HTML Edited.<br /><a href=""admin.aspx"">Click Aquí</a> To Return To The Admin Page.<br /><br />"
        End Sub

        Sub SubmitEmailConfig(ByVal sender As System.Object, ByVal e As System.EventArgs)
            ...
            PagePanel.Visible = "false"
            NoItemsDiv.InnerHtml = "E-Mail Configuration Edited.<br /><a href=""admin.aspx"">Click Aquí</a> To Return To The Admin Page.<br /><br />"
        End Sub

        Sub SubmitVariableConfig(ByVal sender As System.Object, ByVal e As System.EventArgs)
            ...
            PagePanel.Visible = "false"
            NoItemsDiv.InnerHtml = "Custom Variables Edited.<br /><a href=""admin.aspx"">Click Aquí</a> To Return To The Admin Page.<br /><br />"
        End Sub

        Sub SubmitSearchConfig(ByVal sender As System.Object, ByVal e As System.EventArgs)
            ...
            PagePanel.Visible = "false"
            NoItemsDiv.InnerHtml = "Search Configuration Saved.<br /><a href=""admin.aspx"">Click Aquí</a> To Return To The Admin Page.<br /><br />"
        End Sub

        Sub SubmitNewTemplate(ByVal sender As System.Object, ByVal e As System.EventArgs)
            ...
            PagePanel.Visible = "false"
            NoItemsDiv.InnerHtml = "New Template Created Succesfully.<br /><a href=""admin.aspx"">Click Aquí</a> To Return To The Admin Page.<br /><br />"
        End Sub

        Sub CreateNewPage(ByVal sender As System.Object, ByVal e As System.EventArgs)
            Response.Redirect("newpage.aspx")
        End Sub

        Sub EditPages(ByVal sender As System.Object, ByVal e As System.EventArgs)
            Response.Redirect("editpages.aspx?ID=0")
        End Sub

        Sub EditCategory(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Sub NewForum(ByVal sender As System.Object, ByVal e As System.EventArgs)
            Response.Redirect("newforum.aspx?ID=" & sender.SelectedValue.ToString())
        End Sub

        Sub GoToFileManager(ByVal sender As System.Object, ByVal e As System.EventArgs)
            Response.Redirect("admin_filemanager.aspx?ID=0")
        End Sub

        Sub CreateNewMember(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Sub SubmitMemberVerification(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Sub SubmitMemberVerificationEmail(ByVal sender As System.Object, ByVal e As System.EventArgs)
            ...
            If (err = 0) Then
                NoItemsDiv.InnerHtml = "Member Verified Succesfully.<br /><a href=""admin.aspx"">Click Aquí</a> To Return To The Admin Page.<br /><br />"
            Else
                NoItemsDiv.InnerHtml = "The member was verified, however, the e-mail could not be delivered.<br /><br />There is either a problem with your mail setup or the user's e-mail address is not valid.<br /><br /><a href=""admin.aspx"">Click Aquí</a> To Return To The Admin Page.<br /><br />"
            End If
        End Sub

        Sub SubmitMemberVerificationNoEmail(ByVal sender As System.Object, ByVal e As System.EventArgs)
            Database.Write("UPDATE " & Database.DBPrefix & "_MEMBERS SET MEMBER_LEVEL = 1, MEMBER_VALIDATED = 1 WHERE MEMBER_ID = " & sender.CommandArgument)
            PagePanel.Visible = "false"
            NoItemsDiv.InnerHtml = "Member Verified Succesfully.<br /><a href=""admin.aspx"">Click Aquí</a> To Return To The Admin Page.<br /><br />"
        End Sub

        Sub DeleteMemberVerification(ByVal sender As System.Object, ByVal e As System.EventArgs)
            Database.Write("DELETE FROM " & Database.DBPrefix & "_MEMBERS WHERE MEMBER_ID = " & sender.CommandArgument)
            PagePanel.Visible = "false"
            NoItemsDiv.InnerHtml = "Member Deleted Succesfully.<br /><a href=""admin.aspx"">Click Aquí</a> To Return To The Admin Page.<br /><br />"
        End Sub

        Sub DeleteAvatar(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Sub EditRanking(ByVal sender As System.Object, ByVal e As System.EventArgs)
            AdminLinks.visible = "false"
            AdminRankingConfig.visible = "true"
        ...
        Sub DeleteRanking(ByVal sender As System.Object, ByVal e As System.EventArgs)
            AdminLinks.visible = "false"
            AdminRankingConfig.visible = "true"
        ...
        Sub NewRanking(ByVal sender As System.Object, ByVal e As System.EventArgs)
            AdminLinks.visible = "false"
            AdminRankingConfig.visible = "true"
            Dim RankName As String = Functions.Repairstring(NewRankName.Text, 0)
        ...
        Sub UpdateCounts(ByVal sender As System.Object, ByVal e As System.EventArgs)
            Functions.UpdateCounts(1, 0, 0, 0)
            PagePanel.Visible = "false"
            NoItemsDiv.InnerHtml = "Forum Counts Updated.<br /><a href=""admin.aspx"">Click Aquí</a> To Return To The Admin Page.<br /><br />"
        End Sub

        Sub SaveCurseWord(ByVal sender As System.Object, ByVal e As System.EventArgs)
            AdminLinks.visible = "false"
            AdminCurseFilter.visible = "true"
        ...
        Sub DeleteCurseWord(ByVal sender As System.Object, ByVal e As System.EventArgs)
            AdminLinks.visible = "false"
            AdminCurseFilter.visible = "true"
        ...
        Sub NewCurseWord(ByVal sender As System.Object, ByVal e As System.EventArgs)
            AdminLinks.visible = "false"
            AdminCurseFilter.visible = "true"
        ...
        Sub CreateRotator(ByVal sender As System.Object, ByVal e As System.EventArgs)
            AdminLinks.visible = "false"
            AdminRotatorConfig.visible = "false"
            AdminRotatorNew.visible = "true"
        End Sub

        Sub SubmitNewRotator(ByVal sender As System.Object, ByVal e As System.EventArgs)
            AdminRotatorConfig.visible = "false"
            AdminRotatorNew.visible = "false"
        ...
        Sub DeleteRotator(ByVal sender As System.Object, ByVal e As System.EventArgs)
            AdminLinks.visible = "false"
            AdminRotatorConfig.visible = "false"
        ...
        Sub DeleteRotatorConfirm(ByVal sender As System.Object, ByVal e As System.EventArgs)
            ...
            PagePanel.visible = "false"
            NoItemsDiv.InnerHtml = "Image Rotator Deleted Successfully.<br /><a href=""admin.aspx"">Click Aquí</a> To Return To The Admin Page.<br /><br />"
        End Sub

        Sub EditRotator(ByVal sender As System.Object, ByVal e As System.EventArgs)
            AdminLinks.visible = "false"
            AdminRotatorConfig.visible = "false"
            AdminRotatorNewConfirm.visible = "false"
        ...
        Sub DeleteRotatorImage(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Sub ViewHtmlForm(ByVal sender As System.Object, ByVal e As System.EventArgs)
            AdminLinks.visible = "false"
        ...
        Sub DeleteHtmlForm(ByVal sender As System.Object, ByVal e As System.EventArgs)
            AdminLinks.visible = "false"
            AdminHtmlFormConfig.visible = "false"
            AdminHtmlFormView.visible = "false"
        ...
        Sub DeleteHtmlFormConfirm(ByVal sender As System.Object, ByVal e As System.EventArgs)
            Database.Write("DELETE FROM " & Database.DBPrefix & "_HTML_FORMS WHERE FORM_ID = " & sender.CommandArgument)
            PagePanel.visible = "false"
            NoItemsDiv.InnerHtml = "Html Form Results Deleted Successfully.<br /><a href=""admin.aspx"">Click Aquí</a> To Return To The Admin Page.<br /><br />"
        End Sub

        Sub RestoreIP(ByVal sender As System.Object, ByVal e As System.EventArgs)
            ...
            PagePanel.visible = "false"
            NoItemsDiv.InnerHtml = "IP Address And Members Restored Successfully.<br /><a href=""admin.aspx"">Click Aquí</a> To Return To The Admin Page.<br /><br />"
        End Sub

        Sub CreateGallery(ByVal sender As System.Object, ByVal e As System.EventArgs)
            AdminLinks.visible = "false"
        ...
        Sub DeleteGallery(ByVal sender As System.Object, ByVal e As System.EventArgs)
            AdminLinks.visible = "false"
            AdminGalleryConfig.visible = "false"
        ...
        Sub DeleteGalleryConfirm(ByVal sender As System.Object, ByVal e As System.EventArgs)
            ...
            PagePanel.visible = "false"
            NoItemsDiv.InnerHtml = "Photo Gallery Deleted Successfully.<br /><a href=""admin.aspx"">Click Aquí</a> To Return To The Admin Page.<br /><br />"
        End Sub

        Sub EditGallery(ByVal sender As System.Object, ByVal e As System.EventArgs)
            AdminLinks.visible = "false"
            AdminGalleryConfig.visible = "false"
            AdminGalleryNewConfirm.visible = "false"
        ...
        Sub DeleteGalleryPhoto(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Sub SubmitCustomMessages(ByVal sender As System.Object, ByVal e As System.EventArgs)
            ...
            PagePanel.visible = "false"
            NoItemsDiv.InnerHtml = "Custom Messages Edited Successfully.<br /><a href=""admin.aspx"">Click Aquí</a> To Return To The Admin Page.<br /><br />"
        End Sub

        Sub SubmitPMCleanup(ByVal sender As System.Object, ByVal e As System.EventArgs)
            ...
            PagePanel.visible = "false"
            NoItemsDiv.InnerHtml = PMCount & " Private Messages Were Deleted.<br /><a href=""admin.aspx"">Click Aquí</a> To Return To The Admin Page.<br /><br />"
        End Sub
    ...
    Public Class FileManager
        ...
        Function BuildFolderPath(ByVal FID As Integer, ByVal FName As String) As String
        ...
        Sub DeleteFolder(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Sub DeleteFileConfirmation(ByVal sender As System.Object, ByVal e As System.EventArgs)
            FileManagerPanel.visible = "false"
            ConfirmFileDelete.visible = "true"
            FileDeleteButton.CommandArgument = Sender.CommandArgument
        End Sub

        Sub DeleteFile(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Sub CancelDeleteFile(ByVal sender As System.Object, ByVal e As System.EventArgs)
            Response.Redirect("admin_filemanager.aspx?ID=" & Request.QueryString("ID"))
        End Sub

        Sub UploadFolder(ByVal sender As System.Object, ByVal e As System.EventArgs)
            Dim PhysicalUrl As String = System.Web.HttpContext.Current.Request.PhysicalPath
            Dim PhysicalPath As String = Left(PhysicalUrl, Len(PhysicalUrl) - InStr(1, StrReverse(PhysicalUrl), "\"))
    ...
    Public Class CreateMember
        ...
        Sub SubmitNewMember(ByVal sender As System.Object, ByVal e As System.EventArgs)
            ...
            If (Retry = 0) Then
                ...
                PagePanel.visible = "false"
                NoItemsDiv.InnerHtml = "Member Created Successfully.<br /><a href=""admin.aspx"">Click Aquí</a> To Return To The Admin Page.<br /><br />"
            End If
        End Sub
    End Class
