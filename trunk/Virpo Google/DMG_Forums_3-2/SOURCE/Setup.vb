...
Namespace DMGForums.Setup
	...
	Public Class SQLSetup
			...
			if Not Page.IsPostBack() then
				...
				Try
					Dim DatabaseCheck as OdbcDataReader = Database.Read("SELECT " & DBColumn & " FROM " & DBTable)
                        ...
                        Message.text = "You have already installed your database.  Please delete this file from your server for security.<br /><br />If you are attempting to update your forums to the latest version, <a href=""setup-update.aspx"">Click Aquí</a>."
                    Else
                ...
                Catch e1 As System.Data.Odbc.OdbcException
                    MessagePanel.visible = "true"
                    Message.text = "<b>ERROR:</b> There was a SQL error during setup.  View the error message below and then <a href=""setup.aspx"">Click Aquí</a> to try again.<br /><br />" & e1.ToString()
                Catch e2 As Exception
                    MessagePanel.visible = "true"
                    Message.text = "<b>ERROR:</b> There was an error during setup.  View the error message below and then <a href=""setup.aspx"">Click Aquí</a> to try again.<br /><br />" & e2.ToString()
                End Try
            End If
        End Sub

        Sub SubmitInformation(ByVal sender As System.Object, ByVal e As System.EventArgs)
            InformationPanel.visible = "false"
        ...
        Sub SubmitTemplate(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Sub InstallDMGForums(ByVal sender As System.Object, ByVal e As System.EventArgs)
            InformationPanel.visible = "false"
            TemplatePanel.visible = "false"
            ...
            End If
            Try
                Message.text = "You have successfully installed your forum.  <a href=""../default.aspx"">Click Aquí</a> to view the forums and log in to make changes to the layout and content.<br /><br /><b>Be sure to delete the install files from your server for security purposes!<br /><br />Also remember to change to a database security account that does not have full admin privileges.</b>"
    ...
    Public Class Update
            ...
            If Not Page.IsPostBack() Then
                ...
                Try
                    ...
                    ElseIf (CurrentVersion = "-1") Then
                        SetupForm.visible = "false"
                        MessagePanel.visible = "true"
                        Message.text = "You have not run the full installation yet.  <a href=""setup.aspx"">Click Aquí</a> to install the latest version."
                    Else
        ...
        Sub UpdateForums(ByVal sender As System.Object, ByVal e As System.EventArgs)
            SetupForm.visible = "false"
            MessagePanel.visible = "true"
            ...
            Try
                Message.text = "You have successfully upgraded your database to version 3.2.  <a href=""../default.aspx"">Click Aquí</a> to view the forums and log in to make changes to the layout and content.<br /><br /><b>Be sure to delete the install files from your server for security purposes!<br /><br />Also remember to change to a database security account that does not have full admin privileges.</b>"
