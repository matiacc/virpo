...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    <table style="width: 134%">
        ...
        <tr>
            ...
            <td colspan="2">
                <asp:TextBox ID="txtTitulo" runat="server" Width="423px"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td style="width: 2747px">
            ...
            <td style="text-align: left; " colspan="2">
                <asp:FileUpload ID="uploadImagen" runat="server" Width="304px" />
            </td>
        </tr>
        <%--
        <tr>
        ...
        <tr>
            ...
            <td colspan="2">
                <asp:TextBox ID="txtDescripcion" runat="server" Height="78px" Rows="5" 
                    Width="423px" TextMode="MultiLine"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td style="width: 2747px">
            ...
            <td style="text-align: left; " colspan="2">
                ...
                <asp:Label ID="Label8" runat="server" Text=" Moneda  " CssClass="estiloLabel"></asp:Label>
        ...
        <tr>
            <td style="width: 2747px">
                &nbsp;</td>
            <td style="text-align: right; width: 1304px;">
                &nbsp;</td>
