<%@ Page Language="C#" MasterPageFile="~/Virpo.master" AutoEventWireup="true" CodeFile="MisArticulosWiki.aspx.cs"
        ...
        <tr>
            <td>
                <center style="width: 529px; background-color: #333333">
                    <titulosubventana>
                    Mis Articulos WikiMusic</titulosubventana>
                </center>
            </td>
        </tr>
        <tr>
            <td>
                <asp:Label ID="lblResultado" runat="server" Text="No has publicado ningun Articulo"
