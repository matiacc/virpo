<%@ Page Language="C#" MasterPageFile="~/Virpo.master" AutoEventWireup="true" CodeFile="ConfirmarInvitacion.aspx.cs" Inherits="ConfirmarInvitacion" Title="Página sin título" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    ...
    <table class="style1">
        ...
        <asp:Panel ID="Panel1" runat="server" Style="display: none;" CssClass="modalPopup">
            <center>La Invitación fue Aceptada.</center>
        <br />
        <br />
    ...
    <cc1:ModalPopupExtender ID="Panel1_ModalPopupExtender" BackgroundCssClass="modalBackground"
        ...
        <asp:Panel ID="Panel2" runat="server" Style="display: none;" CssClass="modalPopup">
            <center>La Invitación fue Rechazada.</center>
        <br />
        <br />
