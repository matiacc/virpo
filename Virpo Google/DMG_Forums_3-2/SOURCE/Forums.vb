...
Namespace DMGForums.Forums
	...
	Public Class NewCategory
		...
		Sub SubmitCategory(sender As System.Object, e As System.EventArgs)
			...
			if Failure = 0 then
                ...
                NoItemsDiv.InnerHtml = "Category Created Successfully<br /><br /><a href=""ForumHome.aspx"">Click Aquí</a> To Return To The Forums<br /><br />"
            End If
        End Sub
    End Class
    ...
    Public Class EditCategory
        ...
        Sub EditCategory(ByVal sender As System.Object, ByVal e As System.EventArgs)
            ...
            If Failure = 0 Then
                ...
                NoItemsDiv.InnerHtml = "Category Updated Successfully<br /><br /><a href=""ForumHome.aspx"">Click Aquí</a> To Return To The Forums<br /><br />"
            End If
        End Sub
    End Class
    ...
    Public Class DeleteCategory
        ...
        Sub DeleteCategory(ByVal sender As System.Object, ByVal e As System.EventArgs)
            PagePanel.visible = "false"
            ...
            NoItemsDiv.InnerHtml = "Category Deleted Successfully<br /><br /><a href=""ForumHome.aspx"">Click Aquí</a> To Return To The Forums<br /><br />"
        End Sub
    End Class
            ...
            If (Functions.IsInteger(Request.QueryString("ID"))) Then
                ...
                If ForumReader.HasRows() Then
                    While (ForumReader.Read())
                        ...
                        If (ForumReader("FORUM_CONTENT").ToString().Length() > 0) Then
                    ...
                    If (ForumType = 2) Then
                        If (Session("FORUM_" & Request.Querystring("ID")) = "logged") Then
                            ...
                            Else
                                ...
                                NoItemsDiv.InnerHtml = "No hay temas en este foro<br /><br />"
                            End If
                        Else
                            PagePanel.visible = "false"
    ...
    Public Class NewForum
        ...
        Sub SubmitForum(ByVal sender As System.Object, ByVal e As System.EventArgs)
            ...
            If Failure = 0 Then
                ...
                NoItemsDiv.InnerHtml = "Forum Created Successfully<br /><br /><a href=""ForumHome.aspx"">Click Aquí</a> To Return To The Forums<br /><br />"
            End If
        End Sub
    ...
    Public Class EditForum
        ...
        Sub EditForum(ByVal sender As System.Object, ByVal e As System.EventArgs)
            ...
            If Failure = 0 Then
                ...
                NoItemsDiv.InnerHtml = "Forum Edited Successfully<br /><br /><a href=""ForumHome.aspx"">Click Aquí</a> To Return To The Forums<br /><br />"
            End If
        End Sub
    ...
    Public Class DeleteForum
        ...
        Sub DeleteForum(ByVal sender As System.Object, ByVal e As System.EventArgs)
            ...
            NoItemsDiv.InnerHtml = "Forum Deleted Successfully<br /><br /><a href=""ForumHome.aspx"">Click Aquí</a> To Return To The Forums<br /><br />"
        End Sub
    End Class
